...
![Display](https://nagiostv.com/images/nagiostv-0.9.0.png)
...
```console
$ wget https://github.com/chriscareycode/nagiostv-react/releases/download/v0.9.2/nagiostv-0.9.2.tar.gz
```
- Extract the NagiosTV release using tar. This will create a nagiostv/ folder.
```console
$ tar xvfz nagiostv-0.9.2.tar.gz
```
