  ...
  render() {
    ...
    return (
      <div className="sort-and-filter">
        ...
        {(!this.props.hideFilters || this.props.howManyServiceCritical !== 0) && <Checkbox className={this.props.howManyServiceCritical ? 'Checkbox critical uppercase' : 'Checkbox critical uppercase dim'}
        ...
        {(!this.props.hideFilters || this.props.howManyServiceWarning !== 0) && <Checkbox className={this.props.howManyServiceWarning ? 'Checkbox warning uppercase' : 'Checkbox warning uppercase dim'}
          handleCheckboxChange={this.props.handleCheckboxChange}
        ...
        {(!this.props.hideFilters || this.props.howManyServiceUnknown !== 0) && <Checkbox className={this.props.howManyServiceUnknown ? 'Checkbox unknown uppercase' : 'Checkbox unknown uppercase dim'}
          handleCheckboxChange={this.props.handleCheckboxChange}
        ...
        {(!this.props.hideFilters || this.props.howManyServicePending !== 0) && <Checkbox className={this.props.howManyServicePending ? 'Checkbox pending uppercase' : 'Checkbox pending uppercase dim'}
          handleCheckboxChange={this.props.handleCheckboxChange}
        ...
        {(!this.props.hideFilters || this.props.howManyServiceAcked !== 0) && <Checkbox className={this.props.howManyServiceAcked ? 'Checkbox acked uppercase' : 'Checkbox acked uppercase dim'}
          handleCheckboxChange={this.props.handleCheckboxChange}
        ...
        {(!this.props.hideFilters || this.props.howManyServiceScheduled !== 0) && <Checkbox className={this.props.howManyServiceScheduled ? 'Checkbox scheduled uppercase' : 'Checkbox scheduled uppercase dim'}
          handleCheckboxChange={this.props.handleCheckboxChange}
        ...
        {(!this.props.hideFilters || this.props.howManyServiceFlapping !== 0) && <Checkbox className={this.props.howManyServiceFlapping ? 'Checkbox flapping uppercase' : 'Checkbox flapping uppercase dim'}
          handleCheckboxChange={this.props.handleCheckboxChange}
        ...
        {(!this.props.hideFilters || this.props.howManyServiceSoft !== 0) && <Checkbox className={this.props.howManyServiceSoft ? 'Checkbox soft uppercase' : 'Checkbox soft uppercase dim'}
          handleCheckboxChange={this.props.handleCheckboxChange}
