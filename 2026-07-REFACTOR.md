...
- [ ] Split `Settings.tsx`.
  ...
  - Progress: extracted the typed data-source/connection, date/region, display/minimap, alert-history, audio/visual, and menu/logo sections, including reusable polling-frequency, legacy-format, and boolean controls with focused interaction tests.
