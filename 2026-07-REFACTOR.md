...
- [ ] Split `Settings.tsx`.
  ...
  - Progress: extracted the typed data-source/connection, date/region, and display/minimap sections, including reusable polling-frequency, legacy-format, and boolean controls with focused interaction tests.
