...
- [ ] Split `Settings.tsx`.
  ...
  - Progress: extracted the typed data-source/connection, date/region, display/minimap, and alert-history sections, including reusable polling-frequency, legacy-format, and boolean controls with focused interaction tests.
