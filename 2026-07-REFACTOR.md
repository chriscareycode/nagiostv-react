...
- [ ] Split `Settings.tsx`.
  ...
  - Progress: extracted the typed data-source/connection, date/region, display/minimap, alert-history, and audio/visual sections, including reusable polling-frequency, legacy-format, and boolean controls with focused interaction tests.
