...
- [ ] Split `Settings.tsx`.
  ...
  - Progress: extracted the typed data-source/connection and date/region sections, including reusable polling-frequency and legacy-format controls with focused interaction tests.
